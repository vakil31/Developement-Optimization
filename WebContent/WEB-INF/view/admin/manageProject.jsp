        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="title_left">
                    <h3> Manage Project <small>  </small></h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <f:form id="defaultForm" method="post" modelAttribute="dataProject" class="form-horizontal" action="insertProject.htm">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9 col-lg-offset-3">
                                            <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Add Project</button>
                                        </div>
                                    </div>
                                </f:form>
                            </div>
