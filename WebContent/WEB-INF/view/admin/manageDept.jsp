                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <f:form id="defaultForm" method="post" modelAttribute="data" class="form-horizontal" action="insertDept.htm">
                                        
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Dept</label>
                                        <div class="col-lg-5">
                               ...
                               <div class="form-group">
                                        <div class="col-lg-9 col-lg-offset-3">
                                            <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Add Dept</button>
