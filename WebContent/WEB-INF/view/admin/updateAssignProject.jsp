                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <f:form id="defaultForm" method="get" modelAttribute="key" class="form-horizontal" action="updateAssignProject.htm">
                                     <div class="form-group">
                                        <label class="col-lg-3 control-label"></label>
                                        <div class="col-lg-5">
                                            <f:input type="hidden" class="form-control" path="assignProjectId" />
                                        </div>
                                    </div>
                                     <div class="form-group">
							       ...
							       <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <c:forEach items="${staffList}"  var="z">
                                  				  <f:option value="${z.svo.staffId}">${z.svo.fName}</f:option>
                                   			</c:forEach>
                                				</f:select>
                                        </div>
                                    </div>            
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9 col-lg-offset-3">
                                            <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Edit Assignment</button>
