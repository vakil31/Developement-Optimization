                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <f:form id="defaultForm" method="post" modelAttribute="data" class="form-horizontal" action="insertStaff.htm">
                                        
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">First Name</label>
                                        <div class="col-lg-5">
                                            <f:input type="text" class="form-control" path="fName" required="True" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <f:input type="text" class="form-control" path="lName" required="True" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <f:input type="email" class="form-control" path="lvo.email" required="True" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <f:input type="password" class="form-control" path="lvo.password" required="True" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9 col-lg-offset-3">
                                            <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Add Staff</button>
