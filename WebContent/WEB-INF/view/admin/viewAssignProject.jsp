        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
					<a href="addAssignProject.htm">Add Module</a>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-responsive table-striped  table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody> <c:forEach items="${data}" var="i">
                                    ...
                                    <tr>
                                        <td>${i.assignProjectId}</td>
                                        <td>${i.pvo.projectName}</td>
                                         <td>${i.svo.fName}</td>
                                    		 <td><a href="deleteAssignProject.htm?id=${i.assignProjectId}">Delete Assignment | </a><a href="editAssignProject.htm?id=${i.assignProjectId}">Edit Assignment</a></td>
                                    </tr>       
                                </c:forEach>
                            </tbody>
                            </table>
