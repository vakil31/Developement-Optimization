        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
					<a href="addProject.htm">Add Project</a>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-responsive table-striped  table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody> <c:forEach items="${dataProject}" var="i">
                                
                                    <tr>
                                        <td>${i.projectId}</td>
                                        <td>${i.projectName}</td>
                                        <td>${i.projectDetails}</td>
                                    		 <td><a href="deleteProject.htm?id=${i.projectId}">Delete Project | </a><a href="editProject.htm?id=${i.projectId}">Edit Project</a></td>
                                    </tr>       
