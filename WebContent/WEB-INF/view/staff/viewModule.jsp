        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
					<a href="staffAddModule.htm">Add Module</a>
                            ...
                            <table id="example" class="table table-responsive table-striped  table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody> <c:forEach items="${data}" var="i">
                                    ...
                                    <tr>
                                        <td>${i.moduleId}</td>
                                        <td>${i.moduleName}</td>
                                        <td>${i.moduleDetails}</td>
                                        <td>${i.pvo.projectName}</td>
                                    		 <td><a href="staffDeleteModule.htm?id=${i.moduleId}">Delete Module | </a><a href="staffEditModule.htm?id=${i.moduleId}">Edit Module</a></td>
                                    </tr>       
                                </c:forEach>
                            </tbody>
                            </table>
