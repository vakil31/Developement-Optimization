        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
					<a href="staffAddForm.htm">Add Form</a>
                            ...
                            <table id="example" class="table table-responsive table-striped  table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody> <c:forEach items="${data}" var="i">
                                    ...
                                    <tr>
                                        ...
                                        <td>${i.formName}</td>
                                        <td>${i.formDetails}</td>
                                        <td>${i.mvo.moduleName}</td>
                                     
                                    		 <td><a href="staffDeleteForm.htm?id=${i.formId}">Delete Form| </a><a href="staffViewFieldDetails.htm?id=${i.formId}">Details </a></td>
                                    </tr>       
                                </c:forEach>
                            </tbody>
                            </table>
