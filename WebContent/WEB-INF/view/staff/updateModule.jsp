                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <f:form id="defaultForm" method="post" modelAttribute="key" class="form-horizontal" action="staffUpdateModule.htm">
                                     <div class="form-group">
                                        <label class="col-lg-3 control-label"></label>
                                        <div class="col-lg-5">
                                            <f:input type="hidden" class="form-control" path="moduleId" />
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <c:forEach items="${projectList}"  var="i">
                                  				  <f:option value="${i.pvo.projectId}">${i.pvo.projectName}</f:option>
                                   			</c:forEach>
                                				</f:select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <f:input class="form-control" path="moduleName" />
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Module Details</label>
                                        <div class="col-lg-5">
                                            <f:input class="form-control" path="moduleDetails" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-9 col-lg-offset-3">
                                            <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Edit Module</button>
