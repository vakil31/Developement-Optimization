                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <f:form id="defaultForm" method="post" modelAttribute="key" class="form-horizontal" action="staffUpdateProject.htm">
                                     <div class="form-group">
                                        <label class="col-lg-3 control-label"></label>
                                        <div class="col-lg-5">
                                            <f:input type="hidden" class="form-control" path="projectId" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <f:input class="form-control" path="projectName" />
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Project Details</label>
                                        <div class="col-lg-5">
                                            <f:input class="form-control" path="projectDetails" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-lg-9 col-lg-offset-3">
                                            <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Edit Project</button>
										 </div>
                                    </div>
                                </f:form>
                            </div>
